...
let s:bye2_msg = "Plugin vim-sunday will be obsolete."
  \ . " Please use https://github.com/nishigori/increment-activator."
  \ . " Migration Guide: https://github.com/nishigori/increment-activator/wiki/Migrate-from-vim-sunday"
echohl WarningMsg | echomsg s:bye2_msg | echohl None
